            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('entities/save')}}" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{trans('forms.entity_name')}}</label>
                                <div class="col-sm-10">
                                    <input name="name" type="text" class="form-control" placeholder="{{trans('forms.entity_name')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name="city" type="text" class="form-control" placeholder="{{trans('forms.city')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input name="state" type="text" class="form-control" placeholder="{{trans('forms.state')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="zip" type="text" class="form-control" placeholder="{{trans('forms.zip')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="telephone" type="text" class="form-control" placeholder="{{trans('forms.telephone')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="email" type="email" class="form-control" placeholder="{{trans('forms.email')}}">
                                </div>
                            </div>
