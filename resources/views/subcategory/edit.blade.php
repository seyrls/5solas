        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">{{trans('menu.edit_subcategory')}}</div>
                    <div class="panel-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('subcategories/update')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 has-error">
                                    <input name="subcategory" type="text" value="{{$data->subcategory}}" class="form-control" placeholder="{{trans('forms.subcategory_name')}}" required>
                                    <span class="help-block m-b-none">{{trans('forms.mandatory')}}</span>
                                </div>
                            </div>
