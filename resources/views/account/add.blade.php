        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">{{trans('menu.add_account')}}</div>
                    <div class="panel-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('accounts/save')}}">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{trans('forms.account_name')}}</label>
                                <div class="col-sm-6 has-error">
                                    <input name="account_name" maxlength="45" type="text" class="form-control" placeholder="{{trans('forms.account_name')}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 has-error">
                                    <input name="balance" type="decimal" class="form-control" placeholder="{{trans('forms.balance')}}" required>
                                    <span class="help-block m-b-none">{{trans('forms.mandatory')}}</span>
                                </div>
                            </div>
