                            ...
                            @if(!empty($data))
                                @foreach($data as $d)
                                    <tr>
                                        ...
                                        <td>{{trans('forms.symbol_money') . $d->balance}}</td>
                                        <td>{{$d->created_at}}</td>
                                        <td>{{$d->updated_at}}</td>
                                        <td>
                                            <a href="{{url('accounts/edit/'.$d->id)}}" class="btn btn-warning btn-xs">{{trans('menu.edit')}}</a>

                                            <a href="#myModal"  class="btn btn-default btn-xs xx" data-id="{{$d->id}}" data-toggle="modal" onclick="teste('{{$d->id}}', '{{$d->account}}')">{{trans('menu.delete')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
