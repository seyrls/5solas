            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('expenses/update')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="description" type="text" value="{{$data->description}}" class="form-control" placeholder="{{trans('forms.description')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="amount" id="amount" type="text" value="{{$data->amount}}" class="form-control" placeholder="{{trans('forms.amount')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="date" type="date" value="{{$data->date}}" class="form-control" placeholder="{{trans('forms.date')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="observation" type="text" value="{{$data->observation}}" class="form-control" placeholder="{{trans('forms.observation')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name="tag" type="text" value="{{$data->tag}}"  class="form-control" placeholder="{{trans('forms.tag')}}">
                                </div>
                            </div>
