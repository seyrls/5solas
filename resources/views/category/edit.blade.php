            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{url('categories/update')}}">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{trans('forms.category_name')}}</label>
                                <div class="col-sm-6 has-error">
                                    <input name="category" type="text" value="{{$data->category}}" class="form-control" placeholder="{{trans('forms.category_name')}}" required>
